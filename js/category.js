  ...
  (async () => {
    ...
    function createIcon(icon, rowTable) {
      ...
      function editCategoryLocal() {
        ...
        const buttonCreateCategory = document.querySelector(
    ...
    window.showCategory = async function (input) {
      ...
      else insertContentTable(listCategory);
    };
    ...
    hiddenFormRegister(
      document.querySelector("#btn-nova-categoria"),
